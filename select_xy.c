...
{13,4130,1,0,0,
5,0,0,0,0,0,27,156,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,0,0,17,206,0,0,1,1,0,1,0,1,97,0,0,
55,0,0,2,0,0,45,212,0,0,0,0,0,1,0,
70,0,0,2,0,0,13,221,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
93,0,0,2,0,0,15,246,0,0,0,0,0,1,0,
108,0,0,3,0,0,29,248,0,0,0,0,0,1,0,
123,0,0,4,0,0,31,270,0,0,0,0,0,1,0,
};
	...
	while(TRUE){
		...
		if(_kbhit()){
			...
			if(key == 13){
				...
				//system("cls");
				//print_screen1(1,"login.txt");
				//break;
				if(presentCur.dwCursorPosition.Y == 13){
					system("cls");
					//printf("you enter enter");
					print_screen1(1,"login.txt");
					//break;	
					}
				if(presentCur.dwCursorPosition.Y == 21){
					system("cls");
					print_screen1(2,"login.txt");
					//break;				
					}
				if(presentCur.dwCursorPosition.Y == 29){
					system("cls");
					print_screen1(3,"login.txt");
					//break;						
					}
			}
/*
